# -*- coding: utf-8 -*-
#
# routr documentation build configuration file, created by
...
extensions = [
    ...
    'sphinxcontrib.httpdomain', 'routr.doc']
...
latex_documents = [
  ('index', 'routr.tex', u'routr Documentation',
...
man_pages = [
    ('index', 'routr', u'routr Documentation',
     [u'Andrey Popp'], 1)
]
...
texinfo_documents = [
  ('index', 'routr', u'routr Documentation',
   u'Andrey Popp', 'routr', 'One line description of project.',
   'Miscellaneous'),
]
